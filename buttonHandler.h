...
// Realization of functions layer
void volumeChange(int8_t v)
{
    // The positive value is volume up and negative is down

    // idk go make a call to DFMini and set its volume
}

void trackSwipe(int8_t v)
{
    // The positive value is next track and negative is previous

    // idk go make a call to DFMini and set next track
}
...
void optionChange(int8_t v)
{
    // Changes options in menus
}

void selectOption()
{
    // Selects option when youre in menu
}
